...
@section('js')
    <script>
        ...
        $("#couponForm").submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('discount_coupons.store') }}", // Update the URL to your store route
                type: "post",
                data: $(this).serialize(),
                dataType: "json",
                ...
                // $('#code, #name, #discount_amount').on('input change', function() {
                //     // Remove the invalid class for the current field
                //     $(this).removeClass('is-invalid');

                //     // Clear the error message for the current field
                //     $(this).siblings('p').removeClass('invalid-feedback').html('');
                // });
