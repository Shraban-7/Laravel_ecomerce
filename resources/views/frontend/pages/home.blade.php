        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel"
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('front-end/images/carousel-1-m.jpg') }}" />
                        <source media="(min-width: 800px)" srcset="{{ asset('front-end/images/carousel-1.jpg') }}" />
                ...
                <div class="carousel-item">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('front-end/images/carousel-2-m.jpg') }}" />
                        <source media="(min-width: 800px)" srcset="{{ asset('front-end/images/carousel-2.jpg') }}" />
                ...
                <div class="carousel-item">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('front-end/images/carousel-3-m.jpg') }}" />
                        <source media="(min-width: 800px)" srcset="{{ asset('front-end/images/carousel-3.jpg') }}" />
                        <img src="images/carousel-2.jpg" alt="" />
                    </picture>
        ...
        <div class="container">
            ...
            <div class="row pb-3">
                @foreach ($feature_products as $prod)
                    @php
                        $product_img = $prod->product_images->first();
                    @endphp
                    <div class="col-md-3">
